...
public final class QueryUtils {
    ...
    public static ArrayList<QuakeData> extractEarthquakes(String url) {
        ...
        final ArrayList<QuakeData> earthquakes = new ArrayList<QuakeData>();
        try {
            JSONObject rootObject = new JSONObject(makeHttpRequest(createUrl(url)));
            ...
            for(int i=0;i<featuresArray.length();i++)
            {
                ...
                earthquakes.add(new QuakeData(magnitude,place,dateToDisplay,timeToDisplay,url1));
